...
/* harmony export */ });
/* harmony import */ var _checkForTasks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./checkForTasks */ "./src/checkForTasks.js");
/* harmony import */ var _closeForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./closeForm */ "./src/closeForm.js");
/* harmony import */ var _selectRemoveTaskBtns__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./selectRemoveTaskBtns */ "./src/selectRemoveTaskBtns.js");
/* harmony import */ var _taskArray__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./taskArray */ "./src/taskArray.js");
/* harmony import */ var _taskConstructor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./taskConstructor */ "./src/taskConstructor.js");
/* harmony import */ var _validateForm__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./validateForm */ "./src/validateForm.js");
...
function addTask() {
    ...
    document.getElementsByTagName('form').onchange = _validateForm__WEBPACK_IMPORTED_MODULE_5__.validateForm


    //check for duplicates in array
    function findDuplicates() {
        let result = ''
        for (let i = 0; i<_taskArray__WEBPACK_IMPORTED_MODULE_3__.taskArray.length; i++) {
            if (_taskArray__WEBPACK_IMPORTED_MODULE_3__.taskArray[i].title==inputTitle) {
                result = true;
            } else {
                result = false
            }
    ...
    (0,_validateForm__WEBPACK_IMPORTED_MODULE_5__.validateForm)();
    findDuplicates();

    if ((0,_validateForm__WEBPACK_IMPORTED_MODULE_5__.validateForm)()==true && findDuplicates()==false) {
        let newTask = new _taskConstructor__WEBPACK_IMPORTED_MODULE_4__.Tasks(inputTitle,inputDescription,inputDueDate,inputPriority);
        _taskArray__WEBPACK_IMPORTED_MODULE_3__.taskArray.push(newTask)
        console.log(_taskArray__WEBPACK_IMPORTED_MODULE_3__.taskArray)
        ...
        ;(0,_closeForm__WEBPACK_IMPORTED_MODULE_1__.closeForm)()
        ;(0,_selectRemoveTaskBtns__WEBPACK_IMPORTED_MODULE_2__.selectRemoveTaskBtns)();

    } else if ((0,_validateForm__WEBPACK_IMPORTED_MODULE_5__.validateForm)()==true && findDuplicates()==true) {
        alert('Task with this title already exists! Please choose a different one')
    }

    (0,_checkForTasks__WEBPACK_IMPORTED_MODULE_0__.checkForTasks)()
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "checkForTasks": () => (/* binding */ checkForTasks)
/* harmony export */ });
...
function checkForTasks() {
    ...
    tomorrow.setDate(today.getDate() + 1)
        ...
        for (let i = 0 ; i<_taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray.length; i++) {
            if (today.getFullYear() === _taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray[i].dueDate.getFullYear() &&
            ...
            else if (today.getFullYear() != _taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray[i].dueDate.getFullYear() &&
            today.getMonth() != _taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray[i].dueDate.getMonth() &&
            today.getDate() != _taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray[i].dueDate.getDate())
            {todayList.classList.remove('active')}
    }
        for (let i = 0 ; i<_taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray.length; i++) {
            if (tomorrow.getFullYear() === _taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray[i].dueDate.getFullYear() &&
            ...
            else if (tomorrow.getFullYear() != _taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray[i].dueDate.getFullYear() &&
            tomorrow.getMonth() != _taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray[i].dueDate.getMonth() &&
            tomorrow.getDate() != _taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray[i].dueDate.getDate())
    ...
    // iterate and check for priority property of each array element
        for (let i = 0; i<_taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray.length; i++) {
             if (_taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray[i].priority=='Low') {lowList.classList.add('active')}
    }
        for (let i = 0 ; i<_taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray.length; i++) {
            if (_taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray[i].priority=='Medium') {mediumList.classList.add('active')}
    }
        for (let i = 0 ; i<_taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray.length; i++) {
            if (_taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray[i].priority=='High') {highList.classList.add('active')}

    }
    // if at least 1 element of array does not have either low, medium or high priority, remove 'active' class of this list
        for (let i = 0; i<_taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray.length; i++) {
            if (_taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray[i].priority!='Low') {
                lowList.classList.remove('active');
            } else if (_taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray[i].priority!='Medium') {
                mediumList.classList.remove('active')
            } else if (_taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray[i].priority!='High') {
                highList.classList.remove('active');
            }
        }
    // if there are no items in the array, display a message
    if (_taskArray__WEBPACK_IMPORTED_MODULE_0__.taskArray.length==0) {
        todayList.classList.remove('active');
        tomorrowList.classList.remove('active');
        lowList.classList.remove('active');
        mediumList.classList.remove('active');
...
function findTaskTitleToRemove() {
    _selectRemoveTaskBtns__WEBPACK_IMPORTED_MODULE_1__.removeTaskButton.forEach(button => {
...
function removeTaskByTitle (title) {
    let currentTaskIndex = _taskArray__WEBPACK_IMPORTED_MODULE_2__.taskArray.findIndex((i) => {
        return i.title === title;
    })
    _taskArray__WEBPACK_IMPORTED_MODULE_2__.taskArray.splice(currentTaskIndex,1);
...
class Tasks {
    ...
    appendTask(container) {
        ...
        taskDueDate.innerText =     (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(this.dueDate), 'EEEE, MMMM, dd');
...
/* harmony import */ var _checkForTasks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkForTasks */ "./src/checkForTasks.js");
/* harmony import */ var _closeForm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./closeForm */ "./src/closeForm.js");
/* harmony import */ var _getHighTasks__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./getHighTasks */ "./src/getHighTasks.js");
/* harmony import */ var _getLowTasks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./getLowTasks */ "./src/getLowTasks.js");
/* harmony import */ var _getMediumTasks__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./getMediumTasks */ "./src/getMediumTasks.js");
/* harmony import */ var _getTodayTasks__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./getTodayTasks */ "./src/getTodayTasks.js");
/* harmony import */ var _getTomorrowTasks__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./getTomorrowTasks */ "./src/getTomorrowTasks.js");
/* harmony import */ var _getUserNameAvatar__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./getUserNameAvatar */ "./src/getUserNameAvatar.js");
/* harmony import */ var _pageLoad__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./pageLoad */ "./src/pageLoad.js");
/* harmony import */ var _showForm__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./showForm */ "./src/showForm.js");
/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./style.css */ "./src/style.css");
/* harmony import */ var _taskArray__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./taskArray */ "./src/taskArray.js");
/* harmony import */ var _taskConstructor__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./taskConstructor */ "./src/taskConstructor.js");
/* harmony import */ var _validateForm__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./validateForm */ "./src/validateForm.js");
...
(0,_pageLoad__WEBPACK_IMPORTED_MODULE_9__.pageLoad)(_getUserNameAvatar__WEBPACK_IMPORTED_MODULE_8__.userName,_getUserNameAvatar__WEBPACK_IMPORTED_MODULE_8__.userAvatar)

// debug
let taskContainer = document.getElementById('content')

console.log(_taskArray__WEBPACK_IMPORTED_MODULE_12__.taskArray)

//

// task lists
let listTodayButton = document.getElementById('list_today')
listTodayButton.addEventListener('click',_getTodayTasks__WEBPACK_IMPORTED_MODULE_6__.getTodayTasks)

let listTomorrowButton = document.getElementById('list_tomorrow')
listTomorrowButton.addEventListener('click',_getTomorrowTasks__WEBPACK_IMPORTED_MODULE_7__.getTomorrowTasks)

let listLowButton = document.getElementById('list_low');
listLowButton.addEventListener('click',_getLowTasks__WEBPACK_IMPORTED_MODULE_4__.getLowTasks)

let listMediumButton = document.getElementById('list_medium');
listMediumButton.addEventListener('click',_getMediumTasks__WEBPACK_IMPORTED_MODULE_5__.getMediumTasks)

let listHighButton = document.getElementById('list_high');
listHighButton.addEventListener('click',_getHighTasks__WEBPACK_IMPORTED_MODULE_3__.getHighTasks)

//
let showFormButton = document.getElementById('show_form_button')
showFormButton.addEventListener('click', _showForm__WEBPACK_IMPORTED_MODULE_10__.showForm)

let closeFormButton = document.getElementById('close_modal_button');
closeFormButton.addEventListener('click',_closeForm__WEBPACK_IMPORTED_MODULE_2__.closeForm)
